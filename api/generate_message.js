...
export default async function (req, res) {
    ...
    try {
        ...
        // =========================================================================
        // === LÓGICA DA SAUDAÇÃO DINÂMICA (Baseada na hora do servidor) ============
        // =========================================================================
        const currentHour = new Date().getHours();
        let saudacaoHora;

        // Determina "bom dia" (antes das 12h) ou "boa tarde" (12h em diante)
        // O horário atual é: 1:15:40 PM -03 (13:15:40)
        ...
        // =========================================================================
        // === O PROMPT FINAL COM AS 4 ETAPAS E REGRAS DE FORMATAÇÃO =================
        // =========================================================================
        const prompt = `
[INSTRUÇÕES DE GERAÇÃO E FORMATAÇÃO]
Você é um assistente de inteligência artificial da Célula de Formação, Programas e Projetos (CEFOP). Sua tarefa é transformar as informações fornecidas (via Resumo de Texto ${inputContentReference}) em uma mensagem de WhatsApp formal, profissional e padronizada, seguindo RIGOROSAMENTE as 4 etapas de formatação abaixo.
...
Após o Assunto, pule uma linha e escreva a saudação exata: "Caros(as) gestores(as), ${saudacaoHora},".

3ª ETAPA - CORPO DO TEXTO (Comunicação Oficial):
Mantenha um tom de formalidade (comunicações oficiais) e use uma linguagem mais aprimorada. O texto deve ser conciso (máximo de 5 parágrafos curtos) e fluido para o WhatsApp.
...
Utilize negrito (asteriscos duplos, **) nas informações mais importantes, como prazos ou ações críticas.

4ª ETAPA - ENCERRAMENTO PADRONIZADO:
Após o Corpo do Texto (separado por uma ou duas linhas vazias), adicione o encerramento **EXATAMENTE** como especificado abaixo. **IMPORTANTE:** Use a formatação do WhatsApp, onde * é negrito e _ é itálico:

---
Essas informações também foram *enviadas para os Webmail (Zimbra)* das nossas Escolas pela CEFOP SEFOR.

Atenciosamente,
*Célula de Formação, Programas e Projetos - CEFOP*
_Superintendências das Escolas Estaduais de Fortaleza – SEFOR_
